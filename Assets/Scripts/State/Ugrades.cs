public partial class UpgradeState
{
	public void AddStem()
	{
		AvailableStem.Add(new(5, "st1", "Steam Upgrade", "Just better"));
		...
		AvailableStem.Add(new(5, "st2", "Steam Upgrade", "Just better"));
		...
		AvailableStem.Add(new(5, "st3", "Steam Upgrade", "Just better"));
		...
		AvailableStem.Add(new(5, "st4", "Steam Upgrade", "Just better"));
		...
		AvailableStem.Add(new(5, "stS", "Steam Super", "Much better"));
